  ...
  <div class="container">
    ...
    <div class="container-two">
      <p>
        ...
        <a href="https://coc.glazlukasz.pl" target="_blank"><span>coc.glazlukasz.pl</span></a>
        tworzonej przez zespół "<span>glazlukasz.pl</span>".
      </p>

      <p>
        Nasz zespół wsparcia technicznego <span>glazlukasz.pl</span> jest dostępny, aby pomóc Ci w razie problemów z aplikacją lub logowaniem. Prosimy o kontakt na adres e-mailowy:
        <a href="mailto:kontakt@glazlukasz.pl"><span>kontakt@glazlukasz.pl</span></a>.
      </p>

      <p>
        Twoje zgłoszenie jest ważne dla nas, i chcemy zapewnić Ci jak najszybszą i najbardziej satysfakcjonującą pomoc.
      </p>
      <p>Cieszymy się, że jesteś częścią naszej społeczności.</p>
      <hr />
      <p>
        Dziękujemy za wybór naszego serwisu <span>glazlukasz.pl</span> oraz coc.glazlukasz.pl i za to, że jesteś częścią naszej społeczności. Nasz rozwijający się zespół nieustannie pracuje nad doskonaleniem naszej strony internetowej i ceni sobie Twoją opinię.
      </p>
    </div>
    ...
    <div class="feature-list">
      ...
      <ul>
        ...
        <li>Bezpieczne mechanizmy uwierzytelniania i przechowywania danych</li>
        <li>W trakcie budowy nowych funkcji</li>
      </ul>
    </div>

    <h4>Z poważaniem,</h4>
    <h5>Zespół <span>glazlukasz.pl</span> & <span>coc.glazlukasz.pl</span></h5>
...
<html lang="pl">
  ...
  <body>
    <div class="container">
      ...
      <div class="container-two">
        <p>
          Otrzymujesz tę wiadomość, ponieważ wysłałeś prośbę o zresetowanie
          hasła w naszej aplikacji <span>coc.glazlukasz.pl</span>, tworzoną
          przez zespół <span>glazlukasz.pl</span> oraz zespół clanu
          <span>Polska Dezerter</span> <span class="correct-span">[PL]</span>.
        </p>

        <p>
          Aby zresetować hasło, kliknij ten link:
          <a href="${(variables as any).resetLink}"
            >${(variables as any).resetLink}</a
          >
        </p>

        <p>
          Twój token autoryzujący zresetowanie hasła będzie ważny przez 10
          minut. Jeśli wystąpią jakiekolwiek problemy przy zresetowaniu hasła,
          prosimy o kontakt na adres mail:
          <a href="mailto:kontakt@glazlukasz.pl"
            ><span>kontakt@glazlukasz.pl</span></a
          >.
        </p>
      </div>
      <hr />
...
function getSubject(key: MailKey) {
  switch (key) {
    case MailKey.signup:
      return "| coc.glazlukasz.pl | Dziękujemy za rejestrację!";

    case MailKey.forgotPassword:
      return "| coc.glazlukasz.pl | Resetowanie hasła";
  }
}
